...
public class DriveSubsystem extends SubsystemBase {
  ...
  static TalonSRX Left1 = new TalonSRX(RobotMap.Left1);
  static TalonSRX Left2 = new TalonSRX(RobotMap.Left2);
  static TalonSRX Right1 = new TalonSRX(RobotMap.Right1);
  static TalonSRX Right2 = new TalonSRX(RobotMap.Right2);
